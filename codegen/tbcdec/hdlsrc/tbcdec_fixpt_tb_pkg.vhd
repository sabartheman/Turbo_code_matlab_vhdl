-- -------------------------------------------------------------
-- 
-- File Name: /home/sky/Documents/MATLAB/Turbo_codes/codegen/tbcdec/hdlsrc/tbcdec_fixpt_tb_pkg.vhd
...
PACKAGE tbcdec_fixpt_tb_pkg IS
  -- Functions
  ...
  FUNCTION to_hex(x : IN vector_of_unsigned8) RETURN string;
  FUNCTION to_hex(x : IN vector_of_signed8) RETURN string;
END tbcdec_fixpt_tb_pkg;


PACKAGE BODY tbcdec_fixpt_tb_pkg IS
  ...
  FUNCTION to_hex(x : IN vector_of_unsigned8) RETURN string IS
    VARIABLE result : STRING(1 TO 24);
    VARIABLE i      : INTEGER;
    VARIABLE j      : INTEGER;
    VARIABLE k      : INTEGER;
    VARIABLE m      : INTEGER;
