-- -------------------------------------------------------------
-- 
-- File Name: /home/sky/Documents/MATLAB/Turbo_codes/codegen/tbcenc/hdlsrc/tbcenc_fixpt_tb_pkg.vhd
...
PACKAGE tbcenc_fixpt_tb_pkg IS
  -- Functions
  ...
  FUNCTION to_hex(x : IN vector_of_unsigned4) RETURN string;
END tbcenc_fixpt_tb_pkg;


PACKAGE BODY tbcenc_fixpt_tb_pkg IS
  ...
  FUNCTION to_hex(x : IN vector_of_unsigned4) RETURN string IS
